...
export const en: Labels = {
  ...
  site: {
    tagline: 'Artificial intelligence in real estate',
    navHome: 'Home',
    ...
    privacy: 'Privacy',
    legalGermanOnly: 'These notices are available in German only.',
  },

  home: {
    reviewTitle: 'In review: AI@RE 2026',
    conferenceReview:
      'The AI@RE conference has taken place. Over 160 participants. Inspiring keynotes. Compelling deep dives. Intensive break-out sessions. And impressive AI@RE Award winners. Thank you to everyone, and above all to our sponsors.',
    nextConference: 'After the conference is before the conference: AI@RE, Rotkreuz, 7 June 2027',
    partnersWere: 'Our partners were',
    startReadiness: 'Start the Readiness Check',
    startTransformation: 'Start the Transformation Check',
    viewStatistics: 'View statistics',
    leadChange: 'Real estate is changing faster than many companies can respond.',
    leadBody:
      'AI automates processes, shifts roles, moves where value is created. Many companies push digitalisation forward without knowing whether their foundations hold.',
    consequence: 'The result:',
    consequence1: 'Projects that fail — not because of AI, but for want of foundations',
    consequence2: 'Teams that are out of their depth',
    consequence3: 'Strategies that do not take hold',
    checkIs: 'The Readiness Check is your seven-minute assessment.',
    checkShows: 'Neutral, independent and evidence-based, it shows you:',
    shows1: 'How well your data is prepared for AI',
    shows2: 'Where your organisation is stuck — and where it is strong',
    shows3: 'Which capabilities are missing',
    shows4: 'How large your implementation potential really is',
    shows5: 'What you can do straight away to be able to act',
    dimensionsTitle: 'What exactly does the Readiness Check measure?',
    dimensionsLead:
      'We assess your company’s maturity across 7 dimensions that decide whether AI succeeds or fails.',
    dim1: 'Have you defined clearly what you want to use AI for, and why?',
    dim2: 'Is your data usable, structured and reliable?',
    dim3: 'Are your processes digital enough for AI — or full of manual breaks?',
    dim4: 'Who carries responsibility? Who drives AI forward?',
    dim5: 'Does your team understand AI and can it work with it?',
    dim6: 'Is innovation possible, or does fear of risk dominate?',
    dim7: 'Do you have guardrails, security and compliance under control?',
    resultLead:
      'The result shows your complete AI profile at a glance: your strengths and your biggest fields of action.',
    startNow: 'Start the Readiness Check now',
    contactTitle: 'Contact',
    contactLead: 'Let us shape the future together',
    email: 'Email',
    phone: 'Phone',
    address: 'Address',
    formName: 'Name',
    ...
    formSending: 'Sending…',
    formThanks: 'Thank you for your message. We will be in touch shortly.',
    formError:
      'Something went wrong. Please try again later or contact us directly by email.',
  },
  germanOnly: {
    check: 'The Readiness Check is available in German only.',
    transformation: 'The Transformation Check is available in German only.',
  },
  award: {
    title: 'HSLU Best AI@RE Use Case Award 2026',
    whoCanEnter: 'Who can enter?',
    solutionsFrom: 'AI solutions from every part of real estate:',
    fieldValuation: 'Valuation & market intelligence',
    fieldConstruction: 'Construction & planning',
    fieldOperations: 'Operations & energy',
    fieldEsg: 'ESG & portfolio',
    fieldFinance: 'Financing & transactions',
    fieldAgents: 'AI agents & automation',
    prerequisiteLine:
      'Requirements: a real business case · ideally first customers or pilot projects · start-up or a project from an established company',
    requirementsTitle: 'What are the entry requirements?',
    req1: 'A concrete AI use case in construction or real estate',
    req2: 'A working prototype or a finished product',
    req3: 'A start-up, or a project from an established company',
    processTitle: 'How does it work?',
    step1: 'Applications until 30 April 2026, with a short video, via the form below',
    step2: 'A jury nominates 5 candidates from all applications by 10 May 2026',
    step3: 'Live pitch at the conference on 1 June 2026 at the IFZ in Rotkreuz',
    step4: 'Audience vote at the conference',
    step5: 'Award ceremony at the conference on 1 June 2026',
    moreDetails: 'More details',
    apply: 'Apply for the award',
    backHome: 'Back to the home page',

    voteTitle: 'AI@RE Award 2026 · audience vote',
    voteLead:
      'Vote for one of the candidates below. After entering your email you will receive a confirmation.',
    registerConference: 'Register for the conference',
    loading: 'Loading …',
    juryVerdict: 'The jury’s assessment',
    close: 'Close',
    castVote: 'Cast your vote',
    email: 'Email',
    emailUseNote: 'Your email is used only in connection with the AI@RE Award 2026.',
    newsletterOptIn: 'Send me updates about AI@RE.',
    cancel: 'Cancel',
    ...
    openLoom: 'Open on Loom',
    loadCandidatesError: 'The candidates could not be loaded.',
    needEmail: 'Please enter an email address.',
    voteSaveError: 'Your vote could not be saved.',
    genericError: 'Something went wrong.',

    resultsTitle: 'AI@RE Award · votes',
    refreshing: 'Refreshing …',
    countsUnavailable: 'Vote counts temporarily unavailable — bars show 0.',
    votingLabel: 'Voting:',
    winnerReveal: 'And the winner is …',
    startReveal: 'And the winner is, start the animation',
    toOverview: 'To the award overview',
    refreshFailed: 'Refresh failed.',
    loadError: 'Loading failed',
    restartVoting: 'Restart voting',
    stopVoting: 'Stop voting',
    disableDoubleCount: 'Disable double counting',
    enableDoubleCount: 'Enable double counting',
  },
  statistics: {
    ...
    title: 'Is real estate ready for AI?',
    lead: 'Here is where our survey currently stands.',
    ...
    all: 'All',
    demoData: 'Demo data (backend unreachable). The filters have no effect.',
    overallScore: 'Overall score',
    byDimension: 'Distribution by dimension',
    average: 'Average',
    sizeOver1000: 'More than 1000 employees',
    sizeRange: (von: string): string => `${von} employees`,
    chartTotal: 'Total',
    bizAssetManagement: 'Asset management',
    bizFacilityManagement: 'Facility management',
    bizBroker: 'Brokerage',
    bizDevelopment: 'Real estate development',
    bizAdministration: 'Property administration',
    bizConsulting: 'Real estate consulting',
    bizProjectDevelopment: 'Project development',
    bizFinance: 'Real estate finance',
    bizOther: 'Other',
    countryDE: 'Germany',
    countryAT: 'Austria',
    countryCH: 'Switzerland',
    score1: 'Score 1 – Does not apply at all',
    score2: 'Score 2 – Rather does not apply',
    score3: 'Score 3 – Neutral',
    score4: 'Score 4 – Rather applies',
    score5: 'Score 5 – Fully applies',
  },
  marketTest: {
    title: 'Market data (synthetic)',
    subtitle: 'Test interface for the',
    query: 'Query',
    examples: 'Examples:',
    inputSchema: 'Input (inputSchema)',
    outputSchema: 'Output (outputSchema)',
    sectionLocation: 'Location & parameters',
    address: 'Address',
    addressPlaceholder: 'e.g. Bahnhofstrasse 1, 8001 Zürich',
    lat: 'Latitude (lat)',
    lon: 'Longitude (lon)',
    objectType: 'Property type',
    dealType: 'Deal (listings)',
    minRooms: 'Min. rooms',
    maxPrice: 'Max. price CHF',
    listingCount: 'Number of listings',
    trendMetric: 'Trend metric',
    trendMonths: 'Trend months',
    rentAvg: 'Rent ⌀ (CHF/m²/month)',
    priceAvg: 'Purchase price ⌀ (CHF/m²)',
    grossYield: 'Gross yield %',
    vacancy: 'Vacancy %',
    yoy: 'YoY %',
    marketingDays: 'Time on market (days)',
    sample: 'Sample',
    confidence: 'Confidence',
    start: 'Start',
    end: 'End',
    cagr: 'CAGR %',
    needAddressOrCoords: 'Please give an address (≥3 characters) OR a latitude and longitude.',
    matchCoordinates: 'Coordinates',
    matchCity: 'City name',
    matchHash: 'Hash (unreliable)',
    colDeal: 'Deal',
    colRooms: 'Rooms',
    colArea: 'Area m²',
    colPrice: 'Price / rent',
    colDistance: 'Distance m',
    colListed: 'Listed (days)',
    typeApartment: 'Apartment',
    typeCommercial: 'Commercial',
    dealPurchase: 'Purchase price',
    colDescription: 'Description',
    colDefault: 'Default',
  },
}
